...
export default function Budgets() {
    ...
    async function removeBudget(id) {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE}/data/budgets/${id}`, {
                method: 'DELETE'
            })
    ...
    async function editBudget (id, maximum, theme) {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE}/data/budgets/${id}?maximum=${maximum}&theme=${theme}`, {
                method: 'PATCH',
            })
